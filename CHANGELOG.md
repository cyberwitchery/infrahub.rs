...
- schema: the 1.10.0 snapshot came from an instance with a demo schema loaded; the stock snapshot drops its `Dcim*` and `IpamIpAddress` nodes, and with them the generated `dcim` api module
